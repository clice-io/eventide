...
#include "eventide/language/ts.h"

// Generated by scripts/lsp_codegen.py. DO NOT EDIT.
...
struct DidChangeConfigurationRegistrationOptions {
    /// Schema field: section.
    optional_variant<string, std::vector<string>> section = {};
};
...
struct ExecuteCommandRegistrationOptions {
    /// Schema field: workDoneProgress. (Inherited from [ExecuteCommandOptions])
    optional_bool work_done_progress = {};

    /// The commands to be executed on the server (Inherited from [ExecuteCommandOptions])
    std::vector<string> commands;
};
...
struct WorkspaceFoldersServerCapabilities {
    ...
    optional_variant<string, boolean> change_notifications = {};
};
...
struct WorkspaceSymbolRegistrationOptions {
    /// Schema field: workDoneProgress. (Inherited from [WorkspaceSymbolOptions])
    optional_bool work_done_progress = {};

    /// The server provides support to resolve additional
    /// information for a workspace symbol.
    ///
    /// @since 3.17.0 (Inherited from [WorkspaceSymbolOptions])
    optional_bool resolve_provider = {};
};
...
struct ClientSemanticTokensRequestOptions {
    ...
    /// the server provides a corresponding handler.
    optional_variant<boolean, LspEmptyObject> range = {};

    /// The client will send the `textDocument/semanticTokens/full` request if
    /// the server provides a corresponding handler.
    optional_variant<boolean, ClientSemanticTokensRequestFullDelta> full = {};
};
...
struct CreateFile {
    /// An optional annotation identifier describing the operation.
    ///
    /// @since 3.16.0 (Inherited from [ResourceOperation])
    optional<ChangeAnnotationIdentifier> annotation_id = {};
...
struct TextDocumentSyncOptions {
    ...
    /// sent.
    optional_variant<boolean, SaveOptions> save = {};
};

/// @since 3.16.0
struct SemanticTokensDelta {
    /// Schema field: resultId.
    optional<string> result_id = {};
...
struct SemanticTokensOptions {
    ...
    optional_variant<boolean, SemanticTokensFullDelta> full = {};
};
...
struct TextDocumentContentRegistrationOptions {
    ...
    flatten<StaticRegistrationOptions> static_registration_options;
};
...
struct CodeLensParams {
    flatten<WorkDoneProgressParams> work_done_progress_params;

    flatten<PartialResultParams> partial_result_params;
...
struct DiagnosticClientCapabilities {
    ...
    ///
    /// @since 3.15.0 (Inherited from [DiagnosticsCapabilities])
    optional<ClientDiagnosticsTagOptions> tag_support = {};

    /// Client supports a codeDescription property
    ///
    /// @since 3.16.0 (Inherited from [DiagnosticsCapabilities])
...
struct ParameterInformation {
    ...
    optional_variant<string, MarkupContent> documentation = {};
};
...
struct AnnotatedTextEdit {
    ...
    /// text into a document create a range where start === end. (Inherited from [TextEdit])
    Range range;

    /// The string to be inserted. For delete operations use an
    /// empty string. (Inherited from [TextEdit])
    string new_text;
...
struct DocumentSymbol {
    ...
    optional<std::vector<std::shared_ptr<DocumentSymbol>>> children = {};
};
...
struct SelectionRange {
    ...
    optional<std::shared_ptr<SelectionRange>> parent = {};
};
...
struct CompletionItemDefaults {
    ...
    ///
    /// @since 3.17.0
    optional_variant<Range, EditRangeWithInsertReplace> edit_range = {};
...
struct InlayHintLabelPart {
    ...
    optional_variant<string, MarkupContent> tooltip = {};
...
struct SymbolInformation {
    /// The name of this symbol. (Inherited from [BaseSymbolInformation])
    string name;

    /// The kind of this symbol. (Inherited from [BaseSymbolInformation])
    SymbolKind kind;

    /// Tags for this symbol.
    ///
    /// @since 3.16.0 (Inherited from [BaseSymbolInformation])
    optional<std::vector<SymbolTag>> tags = {};

    /// The name of the symbol containing this symbol. This information is for
    /// user interface purposes (e.g. to render a qualifier in the user interface
    /// if necessary). It can't be used to re-infer a hierarchy for the document
    /// symbols. (Inherited from [BaseSymbolInformation])
    optional<string> container_name = {};
...
struct CompletionItem {
    ...
    optional_variant<TextEdit, InsertReplaceEdit> text_edit = {};
...
struct Diagnostic {
    ...
    optional_variant<integer, string> code = {};
...
struct WorkspaceFullDocumentDiagnosticReport {
    ...
    /// An optional result id. If provided it will
    /// be sent on the next diagnostic request for the
    /// same document. (Inherited from [FullDocumentDiagnosticReport])
    optional<string> result_id = {};

    /// The actual items. (Inherited from [FullDocumentDiagnosticReport])
    std::vector<Diagnostic> items;
...
struct NotebookDocumentFilterWithCells {
    ...
    /// value is provided it matches against the
    /// notebook type. '*' matches every notebook.
    optional_variant<string, NotebookDocumentFilter> notebook = {};
...
struct InitializeParams {
    flatten<Lsp_InitializeParams> lsp__initialize_params;

    flatten<WorkspaceFoldersInitializeParams> workspace_folders_initialize_params;
};
...
struct NotebookDocumentSyncRegistrationOptions {
    flatten<NotebookDocumentSyncOptions> notebook_document_sync_options;
...
struct CallHierarchyRegistrationOptions {
    flatten<TextDocumentRegistrationOptions> text_document_registration_options;

    flatten<CallHierarchyOptions> call_hierarchy_options;
...
struct CodeActionRegistrationOptions {
    ...
    flatten<CodeActionOptions> code_action_options;
};
...
struct CodeLensRegistrationOptions {
    ...
    flatten<CodeLensOptions> code_lens_options;
};
...
struct CompletionRegistrationOptions {
    ...
    flatten<CompletionOptions> completion_options;
};

struct DeclarationRegistrationOptions {
    flatten<DeclarationOptions> declaration_options;
...
struct DefinitionRegistrationOptions {
    ...
    flatten<DefinitionOptions> definition_options;
};
...
struct DiagnosticRegistrationOptions {
    ...
    flatten<DiagnosticOptions> diagnostic_options;
...
struct DocumentColorRegistrationOptions {
    ...
    flatten<DocumentColorOptions> document_color_options;
...
struct DocumentFormattingRegistrationOptions {
    ...
    flatten<DocumentFormattingOptions> document_formatting_options;
};
...
struct DocumentHighlightRegistrationOptions {
    ...
    flatten<DocumentHighlightOptions> document_highlight_options;
};
...
struct DocumentLinkRegistrationOptions {
    ...
    flatten<DocumentLinkOptions> document_link_options;
};
...
struct DocumentOnTypeFormattingRegistrationOptions {
    ...
    flatten<DocumentOnTypeFormattingOptions> document_on_type_formatting_options;
};
...
struct DocumentRangeFormattingRegistrationOptions {
    ...
    flatten<DocumentRangeFormattingOptions> document_range_formatting_options;
};
...
struct DocumentSymbolRegistrationOptions {
    ...
    flatten<DocumentSymbolOptions> document_symbol_options;
};

struct FoldingRangeRegistrationOptions {
    flatten<TextDocumentRegistrationOptions> text_document_registration_options;

    flatten<FoldingRangeOptions> folding_range_options;
...
struct HoverRegistrationOptions {
    ...
    flatten<HoverOptions> hover_options;
};

struct ImplementationRegistrationOptions {
    flatten<TextDocumentRegistrationOptions> text_document_registration_options;

    flatten<ImplementationOptions> implementation_options;
...
struct InlayHintRegistrationOptions {
    flatten<InlayHintOptions> inlay_hint_options;
...
struct InlineValueRegistrationOptions {
    flatten<InlineValueOptions> inline_value_options;
...
struct LinkedEditingRangeRegistrationOptions {
    ...
    flatten<LinkedEditingRangeOptions> linked_editing_range_options;
...
struct MonikerRegistrationOptions {
    ...
    flatten<MonikerOptions> moniker_options;
};
...
struct ReferenceRegistrationOptions {
    ...
    flatten<ReferenceOptions> reference_options;
};
...
struct RenameRegistrationOptions {
    ...
    flatten<RenameOptions> rename_options;
};

struct SelectionRangeRegistrationOptions {
    flatten<SelectionRangeOptions> selection_range_options;
...
struct SemanticTokensRegistrationOptions {
    ...
    flatten<SemanticTokensOptions> semantic_tokens_options;
...
struct SignatureHelpRegistrationOptions {
    ...
    flatten<SignatureHelpOptions> signature_help_options;
};
...
struct TextDocumentSaveRegistrationOptions {
    ...
    flatten<SaveOptions> save_options;
};

struct TypeDefinitionRegistrationOptions {
    flatten<TextDocumentRegistrationOptions> text_document_registration_options;

    flatten<TypeDefinitionOptions> type_definition_options;
...
struct TypeHierarchyRegistrationOptions {
    ...
    flatten<TypeHierarchyOptions> type_hierarchy_options;
...
struct ServerCapabilities {
    ...
    optional_variant<TextDocumentSyncOptions, TextDocumentSyncKind> text_document_sync = {};
    ...
    optional_variant<boolean, HoverOptions> hover_provider = {};
    ...
    optional_variant<boolean, DefinitionOptions> definition_provider = {};
    ...
    optional_variant<boolean, ReferenceOptions> references_provider = {};

    /// The server provides document highlight support.
    optional_variant<boolean, DocumentHighlightOptions> document_highlight_provider = {};

    /// The server provides document symbol support.
    optional_variant<boolean, DocumentSymbolOptions> document_symbol_provider = {};

    /// The server provides code actions. CodeActionOptions may only be
    /// specified if the client states that it supports
    /// `codeActionLiteralSupport` in its initial `initialize` request.
    optional_variant<boolean, CodeActionOptions> code_action_provider = {};
    ...
    optional_variant<boolean, WorkspaceSymbolOptions> workspace_symbol_provider = {};

    /// The server provides document formatting.
    optional_variant<boolean, DocumentFormattingOptions> document_formatting_provider = {};
    ...
    optional_variant<boolean, RenameOptions> rename_provider = {};
    ...
    ///
    /// @since 3.16.0
    optional_variant<boolean, MonikerOptions, MonikerRegistrationOptions> moniker_provider = {};
    ...
    ///
    /// @since 3.17.0
    optional_variant<DiagnosticOptions, DiagnosticRegistrationOptions> diagnostic_provider = {};
