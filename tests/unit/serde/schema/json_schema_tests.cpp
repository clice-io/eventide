...
struct with_default {
    std::string name;
    annotation<std::int32_t, schema::default_value> count;
};

struct with_skip {
    std::string visible;
    annotation<std::int32_t, schema::skip> hidden;
};
...
struct with_flatten {
    annotation<base_fields, schema::flatten> base;
    std::string extra;
};

struct with_rename {
    annotation<std::int32_t, schema::rename<"my_field">> x;
    std::string y;
};
...
struct all_default {
    annotation<std::int32_t, schema::default_value> x;
    annotation<std::string, schema::default_value> y;
};
...
struct flatten_opt {
    annotation<base_with_opt, schema::flatten> base;
    std::string tag;
};

struct rename_base {
    annotation<std::int32_t, schema::rename<"alpha">> a;
    std::int32_t b;
};

struct flatten_rename {
    annotation<rename_base, schema::flatten> inner;
    std::string extra;
};
...
namespace js = schema::codegen::json_schema;
...
TEST_CASE(root_bool) {
    const auto result = js::render(schema::type_info_of<bool>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_i8) {
    const auto result = js::render(schema::type_info_of<std::int8_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_i16) {
    const auto result = js::render(schema::type_info_of<std::int16_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_i32) {
    const auto result = js::render(schema::type_info_of<std::int32_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_i64) {
    const auto result = js::render(schema::type_info_of<std::int64_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_u8) {
    const auto result = js::render(schema::type_info_of<std::uint8_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_u16) {
    const auto result = js::render(schema::type_info_of<std::uint16_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_u32) {
    const auto result = js::render(schema::type_info_of<std::uint32_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_u64) {
    const auto result = js::render(schema::type_info_of<std::uint64_t>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_f32) {
    const auto result = js::render(schema::type_info_of<float>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_f64) {
    const auto result = js::render(schema::type_info_of<double>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"number"})");
}
...
TEST_CASE(root_char) {
    const auto result = js::render(schema::type_info_of<char>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_string) {
    const auto result = js::render(schema::type_info_of<std::string>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"string"})");
}
...
TEST_CASE(scalar_wrapper_bool) {
    const auto result = js::render(schema::type_info_of<s_bool>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_i8) {
    const auto result = js::render(schema::type_info_of<s_i8>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_i16) {
    const auto result = js::render(schema::type_info_of<s_i16>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_i32) {
    const auto result = js::render(schema::type_info_of<s_i32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_i64) {
    const auto result = js::render(schema::type_info_of<s_i64>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_u8) {
    const auto result = js::render(schema::type_info_of<s_u8>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_u16) {
    const auto result = js::render(schema::type_info_of<s_u16>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_u32) {
    const auto result = js::render(schema::type_info_of<s_u32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_u64) {
    const auto result = js::render(schema::type_info_of<s_u64>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_f32) {
    const auto result = js::render(schema::type_info_of<s_f32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_f64) {
    const auto result = js::render(schema::type_info_of<s_f64>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"object",)" R"("properties":{)" R"("v":{"type":"number"}},)" R"("required":["v"]})");
}
...
TEST_CASE(scalar_wrapper_char) {
    const auto result = js::render(schema::type_info_of<s_char>());
    EXPECT_EQ(
        result,
...
TEST_CASE(scalar_wrapper_str) {
    const auto result = js::render(schema::type_info_of<s_str>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"object",)" R"("properties":{)" R"("v":{"type":"string"}},)" R"("required":["v"]})");
}
...
TEST_CASE(root_enum_color_i8) {
    const auto result = js::render(schema::type_info_of<color_i8>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_enum_single) {
    const auto result = js::render(schema::type_info_of<single_enum>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_enum_status) {
    const auto result = js::render(schema::type_info_of<status>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_enum_flag_u8) {
    const auto result = js::render(schema::type_info_of<flag_u8>());
    EXPECT_EQ(
        result,
...
TEST_CASE(root_enum_level_i16) {
    const auto result = js::render(schema::type_info_of<level_i16>());
    EXPECT_EQ(
        result,
...
TEST_CASE(container_vec_i32) {
    const auto result = js::render(schema::type_info_of<s_vec_i32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(container_set_i32) {
    const auto result = js::render(schema::type_info_of<s_set_i32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(container_map_str_i32) {
    const auto result = js::render(schema::type_info_of<s_map_str_i32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(container_vec_vec_i32) {
    const auto result = js::render(schema::type_info_of<s_vec_vec_i32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(container_map_str_vec_i32) {
    const auto result = js::render(schema::type_info_of<s_map_str_vec_i32>());
    EXPECT_EQ(
        result,
...
TEST_CASE(tuple_pair) {
    const auto result = js::render(schema::type_info_of<s_pair>());
    EXPECT_EQ(
        result,
...
TEST_CASE(tuple_triple) {
    const auto result = js::render(schema::type_info_of<s_tuple>());
    EXPECT_EQ(
        result,
...
TEST_CASE(tuple_pair_in_struct) {
    const auto result = js::render(schema::type_info_of<with_pair_field>());
    EXPECT_EQ(
        result,
...
TEST_CASE(tuple_in_struct) {
    const auto result = js::render(schema::type_info_of<with_tuple_field>());
    EXPECT_EQ(
        result,
...
TEST_CASE(struct_empty) {
    const auto result = js::render(schema::type_info_of<empty_struct>());
    EXPECT_EQ(
        result,
...
TEST_CASE(struct_single_field) {
    const auto result = js::render(schema::type_info_of<single_field>());
    EXPECT_EQ(
        result,
...
TEST_CASE(struct_point2d) {
    const auto result = js::render(schema::type_info_of<point2d>());
    EXPECT_EQ(
        result,
...
TEST_CASE(struct_with_string) {
    const auto result = js::render(schema::type_info_of<with_string>());
    EXPECT_EQ(
        result,
...
TEST_CASE(nested_inner) {
    const auto result = js::render(schema::type_info_of<inner>());
    EXPECT_EQ(
        result,
...
TEST_CASE(nested_middle) {
    const auto result = js::render(schema::type_info_of<middle>());
    EXPECT_EQ(
        result,
...
TEST_CASE(nested_outer) {
    const auto result = js::render(schema::type_info_of<outer>());
    EXPECT_EQ(
        result,
...
TEST_CASE(nested_with_enum) {
    const auto result = js::render(schema::type_info_of<with_enum>());
    EXPECT_EQ(
        result,
...
TEST_CASE(optional_field) {
    const auto result = js::render(schema::type_info_of<with_optional>());
    EXPECT_EQ(
        result,
...
TEST_CASE(unique_ptr_field) {
    const auto result = js::render(schema::type_info_of<with_unique>());
    EXPECT_EQ(
        result,
...
TEST_CASE(shared_ptr_field) {
    const auto result = js::render(schema::type_info_of<with_shared>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"object",)" R"("properties":{)" R"("name":{"type":"string"},)" R"("ptr":{"type":"integer",)" R"("minimum":-2147483648,)" R"("maximum":2147483647}},)" R"("required":["name"]})");
}
...
TEST_CASE(all_optional_fields) {
    const auto result = js::render(schema::type_info_of<all_optional>());
    EXPECT_EQ(
        result,
...
TEST_CASE(all_ptr_types) {
    const auto result = js::render(schema::type_info_of<with_all_ptr>());
    EXPECT_EQ(
        result,
...
//
// Fields annotated with schema::default_value are not required.
// ---------------------------------------------------------------------------

TEST_CASE(attr_default_value) {
    const auto result = js::render(schema::type_info_of<with_default>());
    EXPECT_EQ(
        result,
...
TEST_CASE(all_default_fields) {
    const auto result = js::render(schema::type_info_of<all_default>());
    EXPECT_EQ(
        result,
...
TEST_CASE(deny_unknown_struct) {
    const static schema::field_info deny_fields[] = {
        {"name",  {}, 0, 0, schema::type_info_of<std::string>(),  false, false, false, false},
        {"count", {}, 0, 1, schema::type_info_of<std::int32_t>(), false, false, false, false},
    };
    const static schema::struct_type_info deny_info = {
        {schema::type_kind::structure, "deny_struct"},
        {deny_fields,                  2            },
        false,
        true, // deny_unknown = true
    };
...
//
// Fields annotated with schema::skip are omitted from the schema entirely.
// ---------------------------------------------------------------------------

TEST_CASE(attr_skip) {
    const auto result = js::render(schema::type_info_of<with_skip>());
    EXPECT_EQ(
        result,
...
TEST_CASE(skip_and_default) {
    const auto result = js::render(schema::type_info_of<skip_default>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"object",)" R"("properties":{)" R"("name":{"type":"string"},)" R"("count":{"type":"integer",)" R"("minimum":-2147483648,)" R"("maximum":2147483647}},)" R"("required":["name"]})");
}
...
//
// Fields annotated with schema::flatten have their inner struct's fields
// inlined into the parent, preserving required/optional status and renames.
// ---------------------------------------------------------------------------

TEST_CASE(attr_flatten) {
    const auto result = js::render(schema::type_info_of<with_flatten>());
    EXPECT_EQ(
        result,
...
TEST_CASE(flatten_with_optional) {
    const auto result = js::render(schema::type_info_of<flatten_opt>());
    EXPECT_EQ(
        result,
...
TEST_CASE(flatten_with_rename) {
    const auto result = js::render(schema::type_info_of<flatten_rename>());
    EXPECT_EQ(
        result,
...
//
// Fields annotated with schema::rename<"name"> use the rename as the
// property key instead of the C++ field name.
// ---------------------------------------------------------------------------

TEST_CASE(attr_rename) {
    const auto result = js::render(schema::type_info_of<with_rename>());
    EXPECT_EQ(
        result,
...
TEST_CASE(variant_untagged) {
    const auto result = js::render(schema::type_info_of<var_none>());
    EXPECT_EQ(
        result,
...
TEST_CASE(variant_three_alts) {
    const auto result = js::render(schema::type_info_of<var_three>());
    EXPECT_EQ(
        result,
...
TEST_CASE(variant_external_tag) {
    const static schema::type_info* ext_alts[] = {
        schema::type_info_of<std::int32_t>(),
        schema::type_info_of<std::string>(),
    };
    const static std::string_view ext_names[] = {"num", "text"};
    const static schema::variant_type_info ext_var = {
        {schema::type_kind::variant, "ext_var"},
        {ext_alts, 2},
        schema::tag_mode::external,
        {},
        {},
        {ext_names, 2},
    };
    const static schema::field_info ext_field = {
        "v",
        {},
        0,
        0,
    ...
    const static schema::struct_type_info ext_wrap = {
        {schema::type_kind::structure, "ext_wrap"},
        {&ext_field,                   1         },
        false,
        false,
    };
...
TEST_CASE(variant_internal_tag) {
    const static schema::type_info* int_alts[] = {
        schema::type_info_of<point2d>(),
        schema::type_info_of<inner>(),
    };
    const static std::string_view int_names[] = {"point", "inner"};
    const static schema::variant_type_info int_var = {
        {schema::type_kind::variant, "int_var"},
        {int_alts, 2},
        schema::tag_mode::internal,
        "type",
        {},
        {int_names, 2},
    };
    const static schema::field_info int_field = {
        "v",
        {},
        0,
        0,
    ...
    const static schema::struct_type_info int_wrap = {
        {schema::type_kind::structure, "int_wrap"},
        {&int_field,                   1         },
        false,
        false,
    };
...
TEST_CASE(variant_adjacent_tag) {
    const static schema::type_info* adj_alts[] = {
        schema::type_info_of<std::int32_t>(),
        schema::type_info_of<std::string>(),
    };
    const static std::string_view adj_names[] = {"num", "text"};
    const static schema::variant_type_info adj_var = {
        {schema::type_kind::variant, "adj_var"},
        {adj_alts,                   2        },
        schema::tag_mode::adjacent,
        "t",
        "c",
        {adj_names,                  2        },
    };
    const static schema::field_info adj_field = {
        "v",
        {},
        0,
        0,
    ...
    const static schema::struct_type_info adj_wrap = {
        {schema::type_kind::structure, "adj_wrap"},
        {&adj_field,                   1         },
        false,
        false,
    };
...
TEST_CASE(map_str_struct) {
    const auto result = js::render(schema::type_info_of<map_str_struct>());
    EXPECT_EQ(
        result,
...
TEST_CASE(map_str_enum) {
    const auto result = js::render(schema::type_info_of<map_str_enum>());
    EXPECT_EQ(
        result,
...
TEST_CASE(vec_optional_items) {
    const auto result = js::render(schema::type_info_of<vec_optional>());
    EXPECT_EQ(
        result,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema",)" R"("type":"object",)" R"("properties":{)" R"("v":{"type":"array",)" R"("items":{"type":"integer",)" R"("minimum":-2147483648,)" R"("maximum":2147483647}}},)" R"("required":["v"]})");
}
...
TEST_CASE(optional_vec_field) {
    const auto result = js::render(schema::type_info_of<optional_vec>());
    EXPECT_EQ(
        result,
...
TEST_CASE(vec_of_enum) {
    const auto result = js::render(schema::type_info_of<vec_enum>());
    EXPECT_EQ(
        result,
...
TEST_CASE(set_of_string) {
    const auto result = js::render(schema::type_info_of<set_string>());
    EXPECT_EQ(
        result,
...
TEST_CASE(vec_of_map) {
    const auto result = js::render(schema::type_info_of<vec_map>());
    EXPECT_EQ(
        result,
...
TEST_CASE(map_of_vec_struct) {
    const auto result = js::render(schema::type_info_of<map_vec_struct>());
...
TEST_CASE(deep_container_field) {
    const auto result = js::render(schema::type_info_of<deep_container>());
    EXPECT_EQ(
        result,
...
TEST_CASE(map_of_map_field) {
    const auto result = js::render(schema::type_info_of<map_of_map>());
    EXPECT_EQ(
        result,
...
TEST_CASE(shared_ptr_to_struct) {
    const auto result = js::render(schema::type_info_of<shared_struct>());
    EXPECT_EQ(
        result,
...
TEST_CASE(optional_struct_field) {
    const auto result = js::render(schema::type_info_of<optional_struct>());
    EXPECT_EQ(
        result,
...
TEST_CASE(defs_dedup_multi_ref) {
    const auto result = js::render(schema::type_info_of<multi_ref>());
    EXPECT_EQ(
        result,
...
TEST_CASE(multi_enum_fields) {
    const auto result = js::render(schema::type_info_of<multi_enum>());
    EXPECT_EQ(
        result,
...
TEST_CASE(with_flag_enum) {
    const auto result = js::render(schema::type_info_of<with_flag>());
    EXPECT_EQ(
        result,
...
TEST_CASE(with_level_enum) {
    const auto result = js::render(schema::type_info_of<with_level>());
    EXPECT_EQ(
        result,
...
TEST_CASE(optional_inner_field) {
    const auto result = js::render(schema::type_info_of<optional_inner>());
    EXPECT_EQ(
        result,
...
TEST_CASE(vec_of_variant) {
    const auto result = js::render(schema::type_info_of<vec_variant>());
    EXPECT_EQ(
        result,
...
TEST_CASE(combo_mixed_fields) {
    const auto result = js::render(schema::type_info_of<combo>());
    EXPECT_EQ(
        result,
...
TEST_CASE(combo_nested_struct_refs) {
    const auto result = js::render(schema::type_info_of<nested_combo>());
    EXPECT_EQ(result,
...
TEST_CASE(combo_vec_of_struct) {
    const auto result = js::render(schema::type_info_of<vec_of_struct>());
    EXPECT_EQ(
        result,
...
TEST_CASE(combo_deep_nesting) {
    const auto result = js::render(schema::type_info_of<deep_outer>());
    EXPECT_EQ(result,
...
TEST_CASE(combo_multi_map) {
    const auto result = js::render(schema::type_info_of<multi_map>());
    EXPECT_EQ(
        result,
...
TEST_CASE(combo_many_fields) {
    const auto result = js::render(schema::type_info_of<many_fields>());
    EXPECT_EQ(
        result,
...
TEST_CASE(combo_set_of_struct) {
    const auto result = js::render(schema::type_info_of<set_of_struct>());
    EXPECT_EQ(
        result,
...
TEST_CASE(combo_trivial_nested) {
    const auto result = js::render(schema::type_info_of<trivial_nested>());
