...
namespace fbs = schema::codegen::fbs;
...
TEST_CASE(scalar_bool) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_bool>()),
              R"fbs(struct s_bool {
  v:bool;
}
...
TEST_CASE(scalar_i8) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_i8>()),
              R"fbs(struct s_i8 {
  v:byte;
}
...
TEST_CASE(scalar_i16) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_i16>()),
              R"fbs(struct s_i16 {
  v:short;
}
...
TEST_CASE(scalar_i32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_i32>()),
              R"fbs(struct s_i32 {
  v:int;
}
...
TEST_CASE(scalar_i64) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_i64>()),
              R"fbs(struct s_i64 {
  v:long;
}
...
TEST_CASE(scalar_u8) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_u8>()),
              R"fbs(struct s_u8 {
  v:ubyte;
}
...
TEST_CASE(scalar_u16) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_u16>()),
              R"fbs(struct s_u16 {
  v:ushort;
}
...
TEST_CASE(scalar_u32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_u32>()),
              R"fbs(struct s_u32 {
  v:uint;
}
...
TEST_CASE(scalar_u64) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_u64>()),
              R"fbs(struct s_u64 {
  v:ulong;
}
...
TEST_CASE(scalar_f32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_f32>()),
              R"fbs(struct s_f32 {
  v:float;
}
...
TEST_CASE(scalar_f64) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_f64>()),
              R"fbs(struct s_f64 {
  v:double;
}
...
TEST_CASE(scalar_char) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_char>()),
              R"fbs(struct s_char {
  v:byte;
}
...
TEST_CASE(scalar_str) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_str>()),
              R"fbs(table s_str {
  v:string;
}
...
TEST_CASE(struct_point2d) {
    EXPECT_EQ(fbs::render(schema::type_info_of<point2d>()),
...
TEST_CASE(struct_with_string) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_string>()),
...
TEST_CASE(struct_single_field) {
    EXPECT_EQ(fbs::render(schema::type_info_of<single_field>()),
...
TEST_CASE(struct_empty) {
    EXPECT_EQ(fbs::render(schema::type_info_of<empty_struct>()),
...
TEST_CASE(enum_with_enum) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_enum>()),
...
TEST_CASE(enum_with_flag) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_flag>()),
...
TEST_CASE(enum_with_level) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_level>()),
...
TEST_CASE(enum_multi_enum) {
    EXPECT_EQ(fbs::render(schema::type_info_of<multi_enum>()),
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
  blue = 2
...
TEST_CASE(attr_with_default) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_default>()),
...
TEST_CASE(attr_with_skip) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_skip>()),
...
TEST_CASE(attr_with_flatten) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_flatten>()),
...
TEST_CASE(attr_with_rename) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_rename>()),
...
TEST_CASE(attr_all_optional) {
    EXPECT_EQ(fbs::render(schema::type_info_of<all_optional>()),
...
TEST_CASE(attr_all_default) {
    EXPECT_EQ(fbs::render(schema::type_info_of<all_default>()),
...
TEST_CASE(attr_skip_default) {
    EXPECT_EQ(fbs::render(schema::type_info_of<skip_default>()),
...
TEST_CASE(flatten_opt) {
    EXPECT_EQ(fbs::render(schema::type_info_of<flatten_opt>()),
...
TEST_CASE(flatten_rename) {
    EXPECT_EQ(fbs::render(schema::type_info_of<flatten_rename>()),
...
TEST_CASE(fallback_pair) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_pair>()),
              R"fbs(table s_pair {
  v:string;
}
...
TEST_CASE(fallback_tuple) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_tuple>()),
              R"fbs(table s_tuple {
  v:string;
}
...
TEST_CASE(fallback_variant) {
    EXPECT_EQ(fbs::render(schema::type_info_of<var_none>()),
...
TEST_CASE(container_vec_i32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_vec_i32>()),
...
TEST_CASE(container_set_i32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_set_i32>()),
...
TEST_CASE(container_map_str_i32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_map_str_i32>()),
...
TEST_CASE(container_map_str_vec_i32) {
    EXPECT_EQ(fbs::render(schema::type_info_of<s_map_str_vec_i32>()),
...
TEST_CASE(container_map_str_struct) {
    EXPECT_EQ(fbs::render(schema::type_info_of<map_str_struct>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(container_map_str_enum) {
    EXPECT_EQ(fbs::render(schema::type_info_of<map_str_enum>()),
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
  blue = 2
...
TEST_CASE(container_vec_optional) {
    EXPECT_EQ(fbs::render(schema::type_info_of<vec_optional>()),
...
TEST_CASE(container_optional_vec) {
    EXPECT_EQ(fbs::render(schema::type_info_of<optional_vec>()),
...
TEST_CASE(container_with_pair_field) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_pair_field>()),
...
TEST_CASE(container_with_tuple_field) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_tuple_field>()),
...
TEST_CASE(container_vec_enum) {
    EXPECT_EQ(fbs::render(schema::type_info_of<vec_enum>()),
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
  blue = 2
...
TEST_CASE(container_set_string) {
    EXPECT_EQ(fbs::render(schema::type_info_of<set_string>()),
...
TEST_CASE(container_vec_map) {
    EXPECT_EQ(fbs::render(schema::type_info_of<vec_map>()),
              R"fbs(table vec_map {
  items:[string];
}
...
TEST_CASE(container_map_vec_struct) {
    EXPECT_EQ(fbs::render(schema::type_info_of<map_vec_struct>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(nested_inner) {
    EXPECT_EQ(fbs::render(schema::type_info_of<inner>()),
              R"fbs(struct inner {
  a:int;
}
...
TEST_CASE(nested_middle) {
    EXPECT_EQ(fbs::render(schema::type_info_of<middle>()),
              R"fbs(struct inner {
  a:int;
}
...
TEST_CASE(nested_outer) {
    EXPECT_EQ(fbs::render(schema::type_info_of<outer>()),
              R"fbs(struct inner {
  a:int;
}
...
TEST_CASE(nested_deep_outer) {
    EXPECT_EQ(fbs::render(schema::type_info_of<deep_outer>()),
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
  blue = 2
...
TEST_CASE(nested_trivial) {
    EXPECT_EQ(fbs::render(schema::type_info_of<trivial_nested>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(optional_with_optional) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_optional>()),
...
TEST_CASE(optional_with_unique) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_unique>()),
...
TEST_CASE(optional_with_shared) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_shared>()),
...
TEST_CASE(optional_with_all_ptr) {
    EXPECT_EQ(fbs::render(schema::type_info_of<with_all_ptr>()),
...
TEST_CASE(optional_shared_struct) {
    EXPECT_EQ(fbs::render(schema::type_info_of<shared_struct>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(combo_optional_struct) {
    EXPECT_EQ(fbs::render(schema::type_info_of<optional_struct>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(combo_optional_inner) {
    EXPECT_EQ(fbs::render(schema::type_info_of<optional_inner>()),
              R"fbs(struct inner {
  a:int;
}
...
TEST_CASE(combo_multi_ref) {
    EXPECT_EQ(fbs::render(schema::type_info_of<multi_ref>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(combo_vec_variant) {
    EXPECT_EQ(fbs::render(schema::type_info_of<vec_variant>()),
...
TEST_CASE(combo_deep_container) {
    EXPECT_EQ(fbs::render(schema::type_info_of<deep_container>()),
...
TEST_CASE(combo_map_of_map) {
    EXPECT_EQ(fbs::render(schema::type_info_of<map_of_map>()),
...
TEST_CASE(combo_mixed_fields) {
    EXPECT_EQ(fbs::render(schema::type_info_of<combo>()),
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
  blue = 2
...
TEST_CASE(combo_nested_combo) {
    EXPECT_EQ(fbs::render(schema::type_info_of<nested_combo>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(combo_multi_map) {
    EXPECT_EQ(fbs::render(schema::type_info_of<multi_map>()),
...
TEST_CASE(combo_vec_of_struct) {
    EXPECT_EQ(fbs::render(schema::type_info_of<vec_of_struct>()),
              R"fbs(struct point2d {
  x:int;
  y:int;
}
...
TEST_CASE(combo_many_fields) {
    EXPECT_EQ(fbs::render(schema::type_info_of<many_fields>()),
...
TEST_CASE(combo_set_of_struct) {
    EXPECT_EQ(fbs::render(schema::type_info_of<set_of_struct>()),
...
TEST_CASE(re_render_point2d) {
    // First call
    auto first = fbs::render(schema::type_info_of<point2d>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<point2d>());
    EXPECT_EQ(first,
              R"fbs(struct point2d {
  x:int;
  y:int;
...
TEST_CASE(re_render_with_enum) {
    // First call
    auto first = fbs::render(schema::type_info_of<with_enum>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<with_enum>());
    EXPECT_EQ(first,
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
...
TEST_CASE(re_render_nested_outer) {
    // First call
    auto first = fbs::render(schema::type_info_of<outer>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<outer>());
    EXPECT_EQ(first,
              R"fbs(struct inner {
  a:int;
}
...
TEST_CASE(re_render_combo) {
    // First call
    auto first = fbs::render(schema::type_info_of<combo>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<combo>());
    EXPECT_EQ(first,
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
...
TEST_CASE(re_render_map_str_i32) {
    // First call
    auto first = fbs::render(schema::type_info_of<s_map_str_i32>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<s_map_str_i32>());
    EXPECT_EQ(first,
              R"fbs(table s_map_str_i32_vEntry {
  key:string (key);
  value:int;
...
TEST_CASE(re_render_deep_outer) {
    // First call
    auto first = fbs::render(schema::type_info_of<deep_outer>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<deep_outer>());
    EXPECT_EQ(first,
              R"fbs(enum color_i8:byte {
  red = 0,
  green = 1,
...
TEST_CASE(re_render_nested_combo) {
    // First call
    auto first = fbs::render(schema::type_info_of<nested_combo>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<nested_combo>());
    EXPECT_EQ(first,
              R"fbs(struct point2d {
  x:int;
  y:int;
...
TEST_CASE(re_render_multi_map) {
    // First call
    auto first = fbs::render(schema::type_info_of<multi_map>());
    // Second call — must produce identical output
    auto second = fbs::render(schema::type_info_of<multi_map>());
    EXPECT_EQ(first,
              R"fbs(table multi_map_aEntry {
  key:string (key);
  value:int;
...
TEST_CASE(cross_type_scalar_then_enum) {
    ...
    auto scalar_result = fbs::render(schema::type_info_of<s_i32>());
...
root_type s_i32;
    ...
    auto enum_result = fbs::render(schema::type_info_of<with_enum>());
...
TEST_CASE(cross_type_nested_then_flat) {
    ...
    auto nested_result = fbs::render(schema::type_info_of<outer>());
...
root_type outer;
    ...
    auto flat_result = fbs::render(schema::type_info_of<single_field>());
...
TEST_CASE(cross_type_map_then_vec) {
    ...
    auto map_result = fbs::render(schema::type_info_of<s_map_str_i32>());
...
root_type s_map_str_i32;
    ...
    auto vec_result = fbs::render(schema::type_info_of<s_vec_i32>());
...
TEST_CASE(cross_type_flatten_then_rename) {
    ...
    auto flatten_result = fbs::render(schema::type_info_of<with_flatten>());
...
root_type with_flatten;
    ...
    auto rename_result = fbs::render(schema::type_info_of<with_rename>());
...
TEST_CASE(cross_type_skip_then_default) {
    ...
    auto skip_result = fbs::render(schema::type_info_of<with_skip>());
...
root_type with_skip;
    ...
    auto default_result = fbs::render(schema::type_info_of<with_default>());
...
TEST_CASE(output_ends_with_newline) {
    ...
    auto result = fbs::render(schema::type_info_of<point2d>());
    EXPECT_EQ(result.back(), '\n');
}

TEST_CASE(output_contains_root_type_for_scalar) {
    auto result = fbs::render(schema::type_info_of<s_bool>());
    EXPECT_EQ(result,
              R"fbs(struct s_bool {
  v:bool;
}
...
TEST_CASE(output_contains_root_type_for_table) {
    auto result = fbs::render(schema::type_info_of<with_string>());
    EXPECT_EQ(result,
              R"fbs(table with_string {
  name:string;
  value:int;
...
TEST_CASE(output_contains_root_type_for_nested) {
    auto result = fbs::render(schema::type_info_of<middle>());
    EXPECT_EQ(result,
              R"fbs(struct inner {
  a:int;
}
...
TEST_CASE(output_contains_root_type_for_enum_struct) {
    auto result = fbs::render(schema::type_info_of<with_level>());
    EXPECT_EQ(result,
              R"fbs(enum level_i16:short {
  low = 0,
  mid = 50,
...
TEST_CASE(output_contains_root_type_for_map) {
    auto result = fbs::render(schema::type_info_of<multi_map>());
    EXPECT_EQ(result,
              R"fbs(table multi_map_aEntry {
  key:string (key);
  value:int;
