...
KOTA_ALWAYS_INLINE void async_init(uv_loop_t& loop,
                                          uv_async_t& handle,
...
KOTA_ALWAYS_INLINE error signal_start(uv_signal_t& handle,
                                             uv_signal_cb cb,
                                             int signum) noexcept {
...
template <stream_like S>
KOTA_ALWAYS_INLINE error read_start(S& stream,
...
KOTA_ALWAYS_INLINE error tcp_bind(uv_tcp_t& handle,
                                         const sockaddr* addr,
...
template <stream_like S>
KOTA_ALWAYS_INLINE result<std::size_t> try_write(S& stream,
...
KOTA_ALWAYS_INLINE error udp_init_ex(uv_loop_t& loop,
                                            uv_udp_t& handle,
                                            unsigned flags) noexcept {
...
KOTA_ALWAYS_INLINE error udp_bind(uv_udp_t& handle,
                                         const sockaddr* addr,
                                         unsigned flags) noexcept {
...
KOTA_ALWAYS_INLINE error udp_getsockname(const uv_udp_t& handle,
                                                sockaddr& name,
                                                int& namelen) noexcept {
    return status_to_error(::uv_udp_getsockname(&handle, &name, &namelen));
}

KOTA_ALWAYS_INLINE error udp_getpeername(const uv_udp_t& handle,
                                                sockaddr& name,
                                                int& namelen) noexcept {
...
KOTA_ALWAYS_INLINE error ip4_name(const sockaddr_in& src,
                                         char* dst,
...
KOTA_ALWAYS_INLINE error ip6_name(const sockaddr_in6& src,
                                         char* dst,
                                         std::size_t size) noexcept {
