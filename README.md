...
However, the raw C API can be hard to use, so we're using [C++ coroutines](https://en.cppreference.com/w/cpp/language/coroutines.html) to build a simple wrapper around it for easier use.
